...
function Products(){
    ...
    return(
        ...
        <div className="container font-sans  pb-3" >
            <div className="bg-blue-600 flex justify-center gap-5 text-center items-center ">
                <div>
                <img src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/flipkart-plus_8d85f4.png" className=" pt-1 pb-1"/>
                </div>
